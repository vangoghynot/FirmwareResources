...
- [Firmware and OS Specifications/Standards/Shows/Events Maintained by TonyLo](#firmware-and-os-specificationsstandardsshowsevents-maintained-by-tonylo)
  ...
  - [Specifications](#specifications)
    ...
    - [Remote Desktop/Connection Protocol](#remote-desktopconnection-protocol)
...
|SD Association |https://www.sdcard.org|Memory Card:<br>- SDCard<br>- MicroSD<br>- SD Express<br>- SDIO<br>- iSDIO
...
|UEFI|https://www.uefi.org|UEFI related Specifications and tools:<br>- UEFI<br>- UEFI PI<br>- ACPI<br>- UEFI SCT
...
|Bluetooth|-[Bluetooth Specifications List](https://www.bluetooth.com/specifications)<br>-[Core Specification 6.2](https://www.bluetooth.com/specifications/specs/core-specification-6-2/)<br>-[Core Specification 6.1](https://www.bluetooth.com/specifications/specs/core-specification-6-1/)<br>-[Core Specification 6.0](https://www.bluetooth.com/specifications/specs/core-specification-6-0/)<br>-[Core Specification 5.4](https://www.bluetooth.com/specifications/specs/core-specification-5-4/)<br>-[Core Specification 5.3](https://www.bluetooth.com/specifications/specs/core-specification-5-3/)<br>-[Core Specification 5.2](https://www.bluetooth.org/docman/handlers/downloaddoc.ashx?doc_id=478726)<br>-[CSS 9](https://www.bluetooth.org/docman/handlers/DownloadDoc.ashx?doc_id=480305)<br>|
...
|HDMI Specification|-[HDMI 2.2 Technology Overview](https://www.hdmi.org/spec/hdmi2) (Released Jun. 25, 2025)<br>-Up to 96Gbps bandwidth, 12K@120Hz, 16K@60Hz, 8K@60/4:4:4, 4K@240/4:4:4<br>-[HDMI 2.2 Press Release](https://hdmiforum.org/hdmi-forum-releases-version-2-2-of-the-hdmi-specification/)<br>-Ultra96 HDMI Cable (96Gbps), Ultra High Speed HDMI Cable (48Gbps)<br>-[HDMI Forum](https://hdmiforum.org/)|
...
|I3C Specification]|-[MIPI I3C Basic v1.0](https://resources.mipi.org/mipi-i3c-v1-download) (Public, RAND-Z license)<br>-[MIPI I3C v1.0](https://www.mipi.org/specifications/i3c-sensor-specification) (Dec. 2017, Public)<br>-[MIPI I3C v1.1](https://www.mipi.org/specifications/i3c-sensor-specification) (Dec. 2019, Members only)<br>-[MIPI I3C v1.1.1](https://www.mipi.org/specifications/i3c-sensor-specification) (Jun. 2021, Members only - Updated terminology to controller/target)<br>-[NXP I3C Training Video](https://www.nxp.com/design/training/improved-inter-integrated-circuit-i3c-standard:TIP-I3C-STANDARD)|
...
|Redfish Specification (DMTF)|-[Information](https://www.dmtf.org/standards/redfish)<br>-[Redfish Release 2025.4 Overview (Jan.16, 2026)](https://www.dmtf.org/sites/default/files/Redfish_Release_2025.4_Overview.pdf)<br>-[Redfish Release 2025.3 Overview](https://www.dmtf.org/sites/default/files/Redfish_Release_2025.3_Overview.pdf)<br>-[Redfish Release 2025.2 Overview](https://www.dmtf.org/sites/default/files/Redfish_Release_2025.2_Overview.pdf)<br>-[Redfish Release 2025.1 Overview](https://www.dmtf.org/sites/default/files/Redfish_Release_2025.1_Overview.pdf)<br>-[Redfish Release 2024.3 Overview](https://www.dmtf.org/sites/default/files/Redfish%20Release%202024.3%20Overview.pdf)<br>-[Redfish Release 2024.2 Overview](https://www.dmtf.org/sites/default/files/Redfish%20Release%202024.2%20Overview.pdf)<br>-[Redfish Release 2024.1 Overview](https://www.dmtf.org/sites/default/files/Redfish%20Release%202024.1%20Overview.pdf)<br><br><br>--------Other Redfish Specifications-----------------<br>-[Redfish Specification 1.23.1 (Jan.16, 2026)](https://www.dmtf.org/sites/default/files/standards/documents/DSP0266_1.23.1.pdf)<br>-[Redfish Specification 1.22.1](https://www.dmtf.org/sites/default/files/standards/documents/DSP0266_1.22.1.pdf)<br>-[Redfish Specification 1.22.0](https://www.dmtf.org/sites/default/files/standards/documents/DSP0266_1.22.0.pdf)<br>-[Redfish Specification 1.21.0](https://www.dmtf.org/sites/default/files/standards/documents/DSP0266_1.21.0.pdf)<br>-[Redfish Host Interface Specification 1.3.1](https://www.dmtf.org/sites/default/files/standards/documents/DSP0270_1.3.1.pdf)<br>|
...
|:-----------------|:-------------------|:-----------------|
|ANSI/VT100|[Terminal Control Sequences](https://www2.ccs.neu.edu/research/gpc/VonaUtils/vona/terminal/vtansi.htm)|Terminal emulation standard|
|AnyDesk|[AnyDesk](https://anydesk.com/)|Commercial remote desktop software|
|Apache Guacamole|[Guacamole](https://guacamole.apache.org/)|Clientless remote desktop gateway (HTML5)|
|FTP (File Transfer Protocol)|[RFC 959](https://datatracker.ietf.org/doc/html/rfc959)|Standard file transfer protocol (unencrypted)|
|FTPS (FTP over SSL/TLS)|[RFC 4217](https://datatracker.ietf.org/doc/html/rfc4217)|FTP with SSL/TLS encryption|
|RDP (Remote Desktop Protocol)|[MS-RDPBCGR](https://learn.microsoft.com/en-us/openspecs/windows_protocols/ms-rdpbcgr/5073f4ed-1e93-45e1-b039-6e30c385867c)|Microsoft Remote Desktop Protocol|
|rsync|[rsync.samba.org](https://rsync.samba.org/)|Fast incremental file transfer utility|
|SCP (Secure Copy Protocol)|[SSH-Based](https://datatracker.ietf.org/doc/html/rfc4251)|Secure file copy over SSH|
|SFTP (SSH File Transfer Protocol)|[RFC Draft](https://datatracker.ietf.org/doc/html/draft-ietf-secsh-filexfer-02)|Secure file transfer over SSH|
|SMB/CIFS|[MS-SMB2](https://learn.microsoft.com/en-us/openspecs/windows_protocols/ms-smb2/)|Server Message Block protocol|
|SPICE|[SPICE Protocol](https://www.spice-space.org/)|Simple Protocol for Independent Computing Environments|
|SSH (Secure Shell)|[RFC 4253](https://datatracker.ietf.org/doc/html/rfc4253)|Secure remote login and command execution|
|TeamViewer|[TeamViewer](https://www.teamviewer.com/)|Commercial remote desktop/support software|
|Telnet|[RFC 854](https://datatracker.ietf.org/doc/html/rfc854)|Unencrypted text-based protocol (legacy)|
|VNC/RFB (Remote Frame Buffer)|-[IETF RFB Protocol RFC 6143](https://datatracker.ietf.org/doc/html/rfc6143)<br>-[RFB Protocol - Github](https://github.com/rfbproto/rfbproto/blob/master/rfbproto.rst)|Virtual Network Computing|
|WebDAV|[RFC 4918](https://datatracker.ietf.org/doc/html/rfc4918)|Web-based Distributed Authoring and Versioning|
|X11/X Window System|[X.Org](https://www.x.org/)|Network-transparent window system|
|XDMCP|[X Display Manager Control Protocol](https://www.x.org/releases/X11R7.6/doc/libXdmcp/xdmcp.html)|Remote X session management|
