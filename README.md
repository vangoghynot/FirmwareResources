...
|:-----------------|:-------------------|:-----------------|:-----------------|
|[ PLe](https://github.com/vangoghynot/UefiResources/tree/master/Tools)![img](img/ple.png)|0.9.6|UEFI(x64/Aarch64)|PLe Provides:<br>**- ACPI<br>- PCIe<br>- SMBIOS<br>- Memory<br>- UEFI<br>- UEFI Variables<br>- UEFI System Tables<br>- UEFI PCDs<br>- CPU (For x64 only)<br>- UEFI Commander<br>**|
